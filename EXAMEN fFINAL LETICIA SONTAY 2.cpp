...
{
	private:
		string id,name,phone,date,address,exam,price,clasif;
	public:
		void menu();
		void insert();
		void insert2();
...
void persona::menu()
{
	...
	cout<<"\t\t\t-------------------------------"<<endl;
	cout<<"\t\t\t 1. Registrar nueva pelicula"<<endl;
	cout<<"\t\t\t 2. Peliculas registradas"<<endl;
	cout<<"\t\t\t 3. Registrar una sala"<<endl;
	cout<<"\t\t\t 4. Resgistrar clientes"<<endl;
	cout<<"\t\t\t 0. Exit"<<endl;
    ...
    case 1:
    	...
    	{
    		insert();
    		cout<<"\n\t\t\t Desea registrar otra pelicula?(Y,N): ";
    		cin>>x;
		}while(x=='y'||x=='Y');
		break;
	case 2:
    ...
    case 4:
    	...
    	{
    		insert3();
    		cout<<"\n\t\t\t Desea Agregar otro cliente?(Y,N): ";
    		cin>>x;
		}while(x=='y'||x=='Y');
		break;
...
void persona::insert()
{
	...
	fstream file;
	cout<<"\n--------------------------------------------------------------------------------";
	cout<<"\n----------------------Ingresar los datos de la pelicula ---------------------------"<<endl;
	cout<<"\t\t\tCodigo de la pelicula          : ";
	cin>>id;
	cout<<"\t\t\tNombre de la pelicula          : ";
	cin>>name;
    cout<<"\t\t\tClasificacion de la pelicula   : ";
	cin>>phone;
	cout<<"\t\t\tIdioma de la pelicula          : ";
	cin>>date;
	cout<<"\t\t\tPrecio de la pelicula          : ";
	cin>>address;
	file.open("Pelicula.txt", ios::app | ios::out);
...
void persona::insert2()
{
	...
	fstream file;
	cout<<"\n--------------------------------------------------------------------------------";
	cout<<"\n----------------------Ingrese los datos de una sala ---------------------------"<<endl;
	cout<<"\t\t\tCodigo de la sala  : ";
	cin>>id;
	cout<<"\t\t\tPrecio             : ";
	cin>>name;
	cout<<"\t\t\tPelicula           : ";
	cin>>price;
	file.open("RegistroSalas.txt", ios::app | ios::out);
...
void persona::insert3()
{
	...
	cout<<"\t\t\tAsientos              : ";
	cin>>date;
	file.open("DatosCliente.txt", ios::app | ios::out);
...
void persona::display()
{
	...
	else
	{
		...
		{
			total++;
			cout<<"\n\n\t\t\t Codigo de la pelicula: "<<id<<endl;
			cout<<"\t\t\t Nombre de la pelicula: "<<name<<endl;
			cout<<"\t\t\t Clasificacion de la pelicula: "<<phone<<endl;
			cout<<"\t\t\t Idioma de la pelicula: "<<date<<endl;
			cout<<"\t\t\t Precio de la pelicula: "<<address<<endl;
			file >> id >> name >> phone >> date >> address;
		}
		if(total==0)
		{
